class Onboarding
  class << self
    ...
    def setup_default_categories!
      ...
      Category.expense.where(title: "Health").first_or_create!(icon: "heart", color: "medium-red")
      ...
      Category.expense.where(title: "Pets").first_or_create!(icon: "paw", color: "dark-green")
      ...
      Category.income.where(title: "Salary").first_or_create!(icon: "banknotes", color: "amber")
    end
